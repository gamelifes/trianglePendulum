(function(){
    ...
    var hour_line = document.getElementById("watch-hour");
    var minute_line = document.getElementById("watch-mintue");
    var second_line = document.getElementById("watch-second");
    var date_info = document.getElementById("date");
    var week_day = [
      '星期日', '星期一', '星期二', '星期三', '星期四', '星期五', '星期六'
    ];
    var hour_date = document.getElementById("hour-time");
    var minute_date = document.getElementById("minute-time");
    var second_date= document.getElementById("second-time");
    function setTime(){
      ...
      hour_date.innerHTML = (this_day.getHours() < 10) ?
          "0" + this_day.getHours() : this_day.getHours();
      minute_date.innerHTML = (this_day.getMinutes() < 10) ?
          "0" + this_day.getMinutes() : this_day.getMinutes();
      second_date.innerHTML = (this_day.getSeconds() < 10) ?
    ...
    function initNumXY(R, r, w, h){
      ...
      for(var i = 0; i < clock_num.length; i++) {
        clock_num[i].style.left = numXY[i].left + 125 + 'px';
